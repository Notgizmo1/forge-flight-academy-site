...
**[Jump to Recreational Requirements →](#recreational-flying)**
...
**[Jump to Commercial Requirements →](#commercial-part-107-flying)**
...
**How to register:**
1. Go to [FAA DroneZone](https://faadronezone.faa.gov/)
2. Create an account
3. Register your drone (takes 5 minutes)
4. Receive registration number via email
5. **Mark your drone** with the registration number (visible on outside or in battery compartment)
...
1. Register drone at [DroneZone](https://faadronezone.faa.gov/) - **5 min, $5**
2. Pass [TRUST test](https://pilotinstitute.com/trust/) - **30 min, FREE**
3. Download [B4UFLY app](https://www.faa.gov/uas/getting_started/b4ufly) - **5 min, FREE**
4. Mark drone with registration number - **2 min**
5. Print/save certificates - **2 min**
6. **Go fly!**
...
- Our [Part 107 Study Guide](/resources/part-107-study-guide/)
- Our [Practice Test](/resources/practice-test/) (50 questions)
...
**Option 3: Professional Training**
We offer comprehensive Part 107 prep as part of our training programs, including **exam fee funding** (up to 2 attempts).
...
1. Go to [FAA DroneZone](https://faadronezone.faa.gov/)
2. Create **Part 107 account**
3. Register drones in UAS inventory
4. Cost: **$5 per drone for 3 years**
...
**How to use LAANC:**
1. Download approved app
2. Create account
3. Select flight location
4. Request authorization
5. Receive instant approval (or denial)
6. Save approval on your device

#### Manual Authorization

If LAANC isn't available or you need >400 ft altitude:

1. Apply via [FAA DroneZone](https://faadronezone.faa.gov/)
2. Submit request **90+ days in advance**
3. Wait for FAA review
...
- Available through [FAA Safety](https://www.faasafety.gov/)
- Takes 1-2 hours
- Instant completion certificate
...
Allowed under specific categories based on aircraft weight and design.
...
1. **Study for Part 107** - **20-40 hours**
2. **Schedule test** at [PSI](https://faa.psiexams.com/) - **$175**
3. **Pass test** (70% required)
4. **Apply in IACRA** - **30 min, FREE**
5. **Register drones** in [DroneZone](https://faadronezone.faa.gov/) - **$5 each**
6. **Download LAANC app** - **FREE**
7. **Start flying commercially!**
...
**[FAA DroneZone](https://faadronezone.faa.gov/)** - Registration and authorizations  
**[TFR List](https://tfr.faa.gov/tfr2/list.html)** - Temporary Flight Restrictions  
**[SkyVector](https://skyvector.com/)** - Sectional charts  
**[Aviation Weather](https://aviationweather.gov/)** - Official aviation weather
...
- **[Part 107 Study Guide](/resources/part-107-study-guide/)** - Complete exam prep
- **[Practice Test](/resources/practice-test/)** - 50 sample questions
- **[Airspace Quick Reference](/resources/airspace-reference/)** - Classes A-G explained
- **[Pre-Flight Checklist](/resources/preflight-checklist/)** - Professional operations checklist
- **[Weight & Balance Calculator](/resources/weight-balance-calculator/)** - Interactive CG calculator

[Browse all free resources →](/resources/)
...
**[Explore Training Programs](/programs/)** | **[Contact Us](/contact/)**
...
**Questions?** Contact us at info@forgeandflightacademy.com

**[Get Free Resources](/resources/)** | **[View Training Programs](/programs/)** | **[Contact Us](/contact/)**

---

*This guide is for informational purposes only. Always check the latest requirements on the [official FAA website](https://www.faa.gov/uas). Regulations are subject to change.*
