  ...
  <div class="container">
    <div style="max-width: 820px; margin: 0 auto;">
      <div class="section-header">
        <h2>The Problem With Military UAS Training Today</h2>
        <p>Most DoD units have platforms. Almost none have the organic training infrastructure to sustain them.</p>
      </div>
      <div class="grid grid-3" style="margin-top: 2rem;">
        ...
        <div class="card" style="text-align: center; border-top: 3px solid #dc2626;">
          <div style="font-size: 2rem; font-weight: 800; color: #dc2626; margin-bottom: 0.5rem;">80%</div>
          <div style="font-size: 0.875rem; color: #4b5563; line-height: 1.5;">Of FPV losses in Ukraine attributed to electronic warfare, not enemy fire</div>
        </div>
        <div class="card" style="text-align: center; border-top: 3px solid #16a34a;">
          <div style="font-size: 2rem; font-weight: 800; color: #16a34a; margin-bottom: 0.5rem;">0</div>
...
<section style="background: #1a2332; padding: 4rem 0;">
  <div class="container">
    <div class="section-header">
      <h2 style="color: white;">What We Deliver That Institutional Training Doesn't</h2>
      <p style="color: rgba(255,255,255,0.7);">Forge and Flight Academy is purpose-built for the operator who needs to be field-ready in days, not the pipeline student who'll see a platform in 18 months.</p>
    </div>
...
<section style="padding: 4rem 0;">
  <div class="container">
    <div class="section-header">
      <h2>Recommended Courses for Military Units</h2>
      <p>Sequenced for maximum capability development. Most units start with FFF-401 and layer FFF-402 once internal demand justifies a dedicated instructor.</p>
    </div>
    <div class="grid grid-3">
      ...
      <div class="card" style="border-top: 4px solid #dc2626;">
        ...
        <p>5 days. Diagnose EW interference, adapt link configs under active jamming, maintain mission continuity in degraded RF. HackRF + PortaPack per student.</p>
        <a href="/courses/ffr-201/" class="btn btn-primary" style="margin-top: 1rem; display: inline-block;">Program Details →</a>
      </div>
      <div class="card" style="border-top: 4px solid #1a2332;">
        <span class="course-code">FFF-402</span>
        <h3>FPV Master Trainer Certification</h3>
        <p>15 days. Certifies an internal instructor who can replicate FFF-401 capability organically. Eliminates recurring contractor training costs entirely.</p>
        <a href="/courses/fff-402/" class="btn btn-primary" style="margin-top: 1rem; display: inline-block;">Program Details →</a>
      </div>
    </div>
  </div>
</section>
...
<section style="background: #f8fafc; padding: 4rem 0; border-top: 1px solid #e2e8f0;">
  <div class="container">
    <div style="max-width: 760px; margin: 0 auto;">
      <div class="section-header">
        <h2>DoD-Ready Contracting</h2>
        <p>All three procurement pathways are open. Proposals returned within 48 hours of request.</p>
      </div>
      <div class="grid grid-3" style="margin-bottom: 2rem;">
        ...
        <div class="card" style="text-align: center;">
          ...
          <div style="font-size: 0.85rem; color: #6b7280;">Military Interdepartmental Purchase Request</div>
        </div>
        <div class="card" style="text-align: center;">
          <div style="font-weight: 700; font-size: 1rem; color: #1a2332; margin-bottom: 0.4rem;">Simplified Acquisition</div>
          <div style="font-size: 0.85rem; color: #6b7280;">Most single-cohort courses fall under $250K SAT threshold</div>
        </div>
      </div>
...
<section style="background: #0f172a; padding: 3.5rem 0;">
  <div class="container" style="text-align: center;">
    <h2 style="color: white; margin-bottom: 0.75rem;">Ready to Build Organic Capability?</h2>
    <p style="color: rgba(255,255,255,0.75); max-width: 520px; margin: 0 auto 1.75rem;">Tell us your unit size, mission requirements, and training timeline. We'll return a complete proposal within 48 hours.</p>
    <a href="/contact/" class="btn btn-primary">Request Unit Training Proposal</a>
  </div>
</section>
