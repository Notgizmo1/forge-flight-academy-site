---
title: "SOCOM Says EW-Realistic Drone Training Is the Gap. Here's How to Close It Before the Ranges Are Built."
description: "At an April 2026 Senate hearing, SOCOM's commander said building electronic-warfare-realistic training ranges in the United States is the training investment he would prioritize with more resources. The gap is real, and it exists at every level of the force, not just special operations."
date: 2026-04-28
draft: false
---
...
*Forge and Flight Academy's RF and electronic warfare curriculum addresses the training gap Admiral Bradley identified. [FFR-201 Tactical RF Fundamentals for UAS Operators](/courses/ffr-201/) and [FFR-301 Advanced Electronic Warfare for UAS Operations](/courses/ffr-301/) provide structured instruction on the spectrum environment, RF-based threat recognition, and operational adaptation under degraded conditions. Paired with [FFF-401 Advanced FPV Systems Integration](/courses/fff-401/), these courses build the combined skill stack that near-peer operations require. [Contact us](/contact/) to discuss scheduling for your unit or organization.*
